...
import './Devupdate.css';
import { useParams } from 'react-router-dom';

export default function Devupdate() {
    ...
    useEffect(() => {
        axios.get('http://localhost:2500/developer/listAll/' + id)
            .then((items) => {
  ...
  return (
    <div className='devupdate'>
    <h2>Developer Update Form</h2>
    <div id='devupdate-list-menu'>
        <div className='devupdate-list bg-light shadow'>
            <form className='form  devupdate-form'>
