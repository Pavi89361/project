...
export default function AddDeveloper() {
    ...
    function Add(){
        axios.post('http://localhost:2500/devop/create',{
            Name:Name,
            Address:Address,
            DOB:DOB,
            Exprience:Exprience,
    ...
    return (
        <div className='add-developer'>
            ...
            <div id='add-developer-main-menu'>
                <div className='add-a-developer  bg-light shadow'>
                    <form className='form  developer-form'>
